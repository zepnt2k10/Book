...
\immini{\subsubsection{Điểm}
	-- Là dấu chấm nhỏ trên giấy.                                                    
	-- Dùng chữ cái in hoa để đặt tên điểm, chẳng hạn $A,B,M,\ldots$  }{
\begin{tikzpicture}
...
Bài 23. Em hãy nêu cách trồng cây thẳng hàng với mỗi trường hợp sau: 
