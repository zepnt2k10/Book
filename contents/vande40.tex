...
\begin{vd}
	...
	\loigiai{
		\textbf{Tìm cách giải:}
		\begin{enumerate}[a),leftmargin=*]
			\i Trên biểu đồ có bao nhiêu biểu tượng , mỗi biểu tượng   ứng với bao nhiêu học sinh. Từ đó tính được số học sinh lớp $8A$.
			...
			\i Tỉ số phần trăm học sinh đi bộ đến trường  = $\frac{\text{Số học sinh đi bộ đến trường}}{\text{Tổng số học sinh lớp 8A}} \cdot 100\%$
		\end{enumerate}
		...
		\begin{enumerate}[a),leftmargin=*]
			...
			\begin{tabular}{|l|c|c|c|c|}
				...
				\hline
			\end{tabular}
			\i Tỉ số phần trăm học sinh đi bộ đến trường là: $\frac{6}{42}\cdot100\% = 14,3 \%$  (kết quả đã được làm tròn đến hàng phần mười)
		\end{enumerate}
	}
\end{vd}
\begin{vd}
