...
\=\kill
\phantom{a}\>
\refstepcounter{dapan}\excircled{\textbf{A.}} #1\dotEX
\>
\refstepcounter{dapan}\excircled{\textbf{B.}} #2\dotEX
\>
\refstepcounter{dapan}\excircled{\textbf{C.}} #3\dotEX
\>
\refstepcounter{dapan}\excircled{\textbf{D.}} #4\dotEX\vspace*{-1.25\parskip}
\end{tabbing}
\end{center}
}
...
\phantom{a}\>\refstepcounter{dapan}\excircled{\textbf{A.}} #1\dotEX\>
\refstepcounter{dapan}\excircled{\textbf{B.}} #2\dotEX\\ 
\phantom{a}\>\refstepcounter{dapan}\excircled{\textbf{C.}} #3\dotEX\>
\refstepcounter{dapan}\excircled{\textbf{D.}} #4\dotEX\vspace*{-1.25\parskip}
\end{tabbing}
}
\newcommand{\motcot}[4]{
\par\noindent
\hspace*{\tabex}\refstepcounter{dapan}\excircled{\textbf{A.}} #1\dotEX\\
\hspace*{\tabex}\refstepcounter{dapan}\excircled{\textbf{B.}} #2\dotEX\\ 
\hspace*{\tabex}\refstepcounter{dapan}\excircled{\textbf{C.}} #3\dotEX\\
\hspace*{\tabex}\refstepcounter{dapan}\excircled{\textbf{D.}} #4\dotEX
}
