...
\renewcommand*\l@part[2]{%
   ...
   \tikz[remember picture, overlay]{
	...
	{\color{violet}\bfseries\fontfamily{pag}\selectfont {\scshape Phần} #1 - Trang #2};
	}
    \par\smallskip
	\penalty\@highpenalty
...
%		+(0.525\textwidth,0) node[anchor=north west] {\pgfornament[width=1cm,symmetry=v]{41}};
   		...
   		\begin{center}
%   		   			{\color{violet}\Huge\sffamily\bfseries Phần \Roman{part}.  \\[12pt]
%   		   		        \MakeUppercase{#2}}
				\textpdfrender{
...
{}
{\color{violet}\thecontentslabel\; }
{}
{\color{violet}\titlerule*[0.65pc]{.}\thecontentspage}
[]
...
{\normalfont\fontsize{10}{12}\bfseries\color{violet}\setcounter{vd}{0}}
