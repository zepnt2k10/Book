...
%\usepackage[paperwidth=16.2cm,paperheight=24.2cm,top=1.75cm,bottom=1.5cm,left=1.75cm,right=1.5cm, includefoot=false,includehead=false]{geometry}
\usepackage[width=19.40cm, height=26.90cm, left=2.20cm, right=2.20cm, top=2.20cm, bottom=2.20cm]{geometry}
\setlength{\parindent}{0.6cm}
\setlength{\parskip}{5pt}
\linespread{1.5}  % dãn dòng
...
\renewcommand{\thesubsubsection}{\arabic{section}.\arabic{subsection}.\arabic{subsubsection}.} \renewcommand{\theequation}{\arabic{chapter}.\arabic{section}.\arabic{equation}}
